...
entrada=degrau(step_u,0.1,time)# exogenous input
...
ic1 = dde.IC(geom, lambda v: x0, boundary, component=0)
ic2 = dde.IC(geom, lambda v: x0, boundary, component=1)
ic3 = dde.IC(geom, lambda v: x0, boundary, component=2)
